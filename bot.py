...
def ln(l,s,arg = None) :
    if s == 'started' :
        if l == 'en' :
            return '💫 *Welcome to "iblue Anti Spam Bot" :)*\n⚜️ _Bot Created  in _ _ with ❤️ by @iborn\nChoose One:_'
        else :
            return '💫 به ربات "آنتی اسپم مجیک " خوش  :)\n⚜️ ساخته شده در   با ❤️ توسط @iborn\nیکی را انتخاب کنید: '
    if s == 'newsubset' :
        if l == 'en' :
